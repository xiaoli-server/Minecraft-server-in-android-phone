                          在安卓手机上一键部署我的世界服务器
如标题所示，这是个能够在手机上一键快速部署我的世界服务器的脚本。我知道，这听起来非常离谱，然而，我们可以通过使用一款功能强大的模拟linux命令行的软件——termux来实现这个疯狂的想法。

在下载该脚本之前，需要您先自行下载MT管理器与termux，termux在github里有，直接搜索就行，而MT管理器可以在应用商店里下载。做完准备工作后，我们就可以准备开始了。

每一个版本下载方式都会有一定的差异，启动方式如下：
1.0版本：解压压缩包
1.1~1.5：在termux输入curl -O https://raw.githubusercontent.com/xiaoli-server/Minecraft-server-in-android-phone/refs/heads/main/脚本版本.sh
每一个版本的更新内容全在发行版界面有介绍
...
本项目将从1.5版本之后将完成测试，后续更新将不在此仓库更新，新项目请到本人主页寻找
