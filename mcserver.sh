...
curl -O https://raw.githubusercontent.com/xiaoli-server/Minecraft-server-in-android-phone/eula.txt #下载配置好的eula协议
curl -O https://raw.githubusercontent.com/xiaoli-server/Minecraft-server-in-android-phone/server.properties #下载配置好的服务器配置文件
