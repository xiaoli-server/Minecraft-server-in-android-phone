...
curl -O https://raw.githubusercontent.com/xiaoli-server/Minecraft-server-in-android-phone/refs/heads/main/Version_selection.py #下载版本储存库
...
cd /storage/emulated/0/mcserver/.fabric/server/
