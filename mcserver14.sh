...
curl -O https://raw.githubusercontent.com/xiaoli-server/Minecraft-server-in-android-phone/refs/heads/main/Version_selection14.py #下载版本选择库
python Version_selection14.py  #运行版本选择库
cd /storage/emulated/0/
mkdir mcserver/1.21.11 #创建服务器文件夹
...
cd /storage/emulated/0/mcserver/ 
